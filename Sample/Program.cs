...
namespace Sample
{
	class Program
	{
                    ...
                    case 'b':
                        {
                            ...
                            _client.Publish2(a, m, QoS.AtLeastOnce, 30, "", "{\"notification_title\":\"你好\", \"notification_content\":\"云巴推送\"}");
                        }
                        break;
                    case 'c':
                        {
                            ...
                            _client.Publish2Alias(a, m, QoS.AtLeastOnce, 30, "", "{\"notification_title\":\"你好\", \"notification_content\":\"云巴推送\"}");
                        }
                        break;
                    default:
		...
		void client_Connected(object sender, EventArgs e)
		{
            ...
            _client.Publish2("pubtest2", "中文", QoS.AtLeastOnce, 0, JsonConvert.SerializeObject(opts));
             */
		}
